    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 slideInRight">
                ...
                <div class="btn-section"><a href="/vacancy/search" class="btn-default">Найти</a></div>
            ...
            <div class="container">
                <div class="col-md-8 col-md-offset-2 col-sm-12 text-center">
                    ...
                    <div class="download-cta fadeInLeft">
                        <a href="#" class="btn-secondary" data-toggle="modal" data-target="#create-vacancy-modal">Разместить вакансию</a>
                    </div>
                </div>
            </div>
        </div>
